...
function MyCompanyDashboard() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/company/profile", config)
      .then((resp) => {
        ...
        <Row>
          ...
          >
            ...
            <Row>
              ...
              <Col className="Heading bg-gradient-to-r text-transparent from-primary to-secondary bg-clip-text">Welcome {data.companyName}</Col>
            </Row>
