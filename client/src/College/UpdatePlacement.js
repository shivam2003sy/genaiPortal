...
function UpdatePlacement() {
  ...
  const handleClick = (e) => {
    ...
    axios
      .post("http://localhost:5000/college/addPlacement", fd, data)
      .then((resp) => {
        console.log(resp);
      ...
      <Container fluid>
        <Row>
          ...
          >
            ...
            <Row>
              <Col className="Heading bg-gradient-to-r text-transparent from-primary to-secondary bg-clip-text">Add Placement</Col>
            </Row>
            <Row>
              <Col>
                <Form>
