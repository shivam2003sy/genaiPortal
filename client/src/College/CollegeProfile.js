...
function CollegeProfile({ val }) {
  ...
  useEffect(() => {
    if (val === "1") handleClick1();
    else if (val === "2") handleClick2();
    else if (val === "3") handleClick3();
    else if (val === "4") handleClick4();
    else if (val === "5") handleClick5();
    else if (val === "6") handleClick6();
    else if (val === "7") handleClick7();
  }, []);
  ...
  return (
    <React.Fragment>
      <Col
        ...
        sm="12"
        xs="12"
        style={{ color: "white",background: "linear-gradient(to right, #D63484, #1d4ed8)", paddingTop: "2%" }}
      >
        <div
          style={{
            fontSize: "160%",
